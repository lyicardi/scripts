...
gg.searchNumber('1.1D;1.4D:2::10', gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1) 
    ...
    gg.searchNumber('1.1F;1.4F:3::1', gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1) 
    gg.searchNumber('1.1D;1.4D:2::10', gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
    gg.toast('鉁旓笍 Security removed 馃挴')
    BP=0
end
...
'馃敟INFINITY No Recoil (Working All Guns)馃敟',
'馃拃DEADLY AimBot馃拃',
'鉁∕agic Bullet鉁�',
'馃敀Aim Lock馃敀',
'Antenna Always  ( In Game )',
'Big Head',
'馃拃SUPER DAMAGE GENERATOR馃拃 (improved)', 
...
function BER()
  ...
  gg.clearResults()
  gg.toast("Body Emerald activated馃憤")
end
